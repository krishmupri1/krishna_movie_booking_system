...
public interface MovieRepository extends JpaRepository<Movie, Long> {
	...
	@Query(value = "select m_id, m_name table_movie, table_show as s  where s.the_theater_t_id = ?1", nativeQuery = true)
	public List<Object[]> getMovieByMovieName(String m_name);
